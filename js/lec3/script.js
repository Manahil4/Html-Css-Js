...
// two methods of doing same thing
console.log('Name of student is',mano.Name,'her uni is',mano.Uni);
// 1st use; string Interpolation: create string by substitution of placeholders
// eg;`str ${expression} str` 
output=`Name of student is ${mano.Name} her uni is ${mano.Uni}`;
console.log(output);

//Escape Characters : count as 1 character ;\n(gives next line on screen),\t(for tab space)
let initials='M\tE';
console.log(initials.length,'\n');

console.log(`dxcjyughjknbvcxzs\tdrftgyhuj\nkmvcxsertyuijk\nnbbvcxzasertyuijkmnhhgesdfvghbnwertyuicvbn\tzsxdfcvghbjk`);
console.log('dxcjyughjknbvcxzs\tdrftgyhuj\nkmvcxsertyuijk\nnbbvcxzasertyuijkmnhhgesdfvghbnwertyuicvbn\tzsxdfcvghbjk');

// Strings are immutable(to update a str) methods:str.toUpperCase(),sttr.toLowerCase()
